...
import com.example.fitx.databinding.BaseballWorkoutsFragBinding
...
class BaseballWorkouts : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Code to start dumbbellRows video
        val dumbbellRowsYoutubeButton = view.findViewById<Button>(R.id.dumbbellRowsPlayVideo)
        dumbbellRowsYoutubeButton.setOnClickListener {
            //TODO(getVideo ID from database)
